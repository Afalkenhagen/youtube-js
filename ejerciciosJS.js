...
const palindromo = (palabra="")=>{
  ...
  return(palabra===alReves)
    ...
    :console.warn(`No es palindromo, Palabra original ${palabra}, palabra al reves ${alReves}`)
}
...
eliminarCaracteres("Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iure excepturi enim ex reprehenderit, sapiente debitis optio, totam reiciendis modi dolorem hic aliquam maiores et nobis magnam blanditiis! Saepe, eaque dolorem!", "o");
...
console.log("Ejercicios de Lógica de Programación ( 4 / 10 )");
    ...
    const convertirGrados = (grados = undefined, unidad = undefined)=>{
      ...
      if (unidad===undefined) return console.warn("No ingresaste el tipo de grados grado a convertir");
